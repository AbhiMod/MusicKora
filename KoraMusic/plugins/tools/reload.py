...
from KoraMusic.utils.database import get_authuser_names, get_cmode
from KoraMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from KoraMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Kora.stop_stream(message.chat.id)
    except:
        pass
